...
export class CustomersController extends AppController<
	CustomerDocument,
	CreateCustomerDto,
	UpdateCustomerDto
> {
	...
	// 			await this.customersStripeService.createCustomer({
	// 				name: `${createAuthDto.firstName} ${createAuthDto.lastName}`,
	// 			});
	// 		const customers = await this.customersService.create({
	// 			user,
